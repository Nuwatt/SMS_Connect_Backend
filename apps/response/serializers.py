...
class SummitQuestionnaireResponseSerializer(serializers.ModelSerializer):
    ...
    def validate_question(self, value):
        questionnaire = self.context['view'].get_object().response_cycle.questionnaire
...
class ListAgentResponseSerializer(serializers.Serializer):
    ...
    questionnaire_name = serializers.CharField(source='response_cycle.questionnaire.name')
    questionnaire_type = serializers.CharField(source='response_cycle.questionnaire.questionnaire_type')
    start_time = serializers.DateTimeField(source='started_at', format='%p %H:%M')
...
class ListQuestionnaireAnswerSerializer(serializers.Serializer):
    ...
    def get_answer(self, instance):
        ...
        if question_type.name == 'Numeric':
            ...
            return [instance.choiceanswer.choice.choice]
