...
class OverviewPriceMonitorSnapReport(serializers.Serializer):
    sku = serializers.CharField(source='sku_name')
    min = serializers.IntegerField(source='min_value')
    max = serializers.IntegerField(source='max_value')
    mode = serializers.IntegerField(source='mode_value')
    mean = serializers.IntegerField(source='mean_value')
